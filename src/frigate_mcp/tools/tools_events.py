...
def register_event_tools(mcp: Any, client: Any) -> None:
    ...
    async def get_event_summary(
        ...
        has_clip: Annotated[bool | None, Field(default=None, description="Only count events with a video clip")] = None,
        has_snapshot: Annotated[bool | None, Field(default=None, description="Only count events with a snapshot")] = None,
    ) -> dict[str, Any]:
        ...
        summary = await client.get_event_summary(
            timezone=timezone, has_clip=has_clip, has_snapshot=has_snapshot
        )
